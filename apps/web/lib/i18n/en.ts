...
export const en = {
  ...
  chat: {
    ...
    syncOffConfirm: "Turn off sync and delete your chats from your account? They stay in this browser.",
  ...
  wallet: {
    close: "Close",
    signInTitle: "Sign in",
    signInText: "Keep your chats on every device, get Pro and invite friends. No password.",
    ...
    sendCode: "Send code",
    sending: "Sending…",
    codeSent: (email: string) => `We sent a 6-digit code to ${email}. It works for 10 minutes.`,
    ...
    walletNeededForKeys: "Link a wallet to create API keys.",
    back: "Back",
    ...
    accessText: "Everything below is tied to this account. Tier:",
  ...
  dashboard: {
    title: "Dashboard",
    gateTitle: "Sign in to see your account",
    gateText: "Use Google, email or a wallet. Your usage, API keys and invites live here.",
    connect: "Sign in",
    manageKeys: "Manage keys",
    invite: "Invite friends",
    inviteText: (days: number) =>
      `Share your link. When someone who joined through it buys Pro, you get ${days} days of Pro, free.`,
    inviteStats: (joined: number, upgraded: number, days: number) =>
      `${joined} joined · ${upgraded} upgraded · ${days} Pro days earned`,
    copyLink: "Copy link",
    copied: "Copied",
  ...
  pro: {
    ...
    viaPass: "Pro is on through your Dualyne Pass, for as long as this wallet holds it.",
    period: "Length",
