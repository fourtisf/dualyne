...
export NEXT_PUBLIC_PASS_NFT_ADDRESS="${NEXT_PUBLIC_PASS_NFT_ADDRESS:-${PASS_NFT_ADDRESS:-}}"
export NEXT_PUBLIC_CHAT_LIMIT_PER_DAY="${NEXT_PUBLIC_CHAT_LIMIT_PER_DAY:-${CHAT_LIMIT_PER_DAY:-10}}"
export NEXT_PUBLIC_API_OPEN="${NEXT_PUBLIC_API_OPEN:-${API_OPEN:-false}}"
export NEXT_PUBLIC_PRO_OPEN="${NEXT_PUBLIC_PRO_OPEN:-${PRO_OPEN:-false}}"
export NEXT_PUBLIC_PRO_PRICE_USD="${NEXT_PUBLIC_PRO_PRICE_USD:-${PRO_PRICE_USD:-19}}"
export NEXT_PUBLIC_PRO_DAYS="${NEXT_PUBLIC_PRO_DAYS:-${PRO_DAYS:-30}}"
export NEXT_PUBLIC_PRO_CHAT_PER_DAY="${NEXT_PUBLIC_PRO_CHAT_PER_DAY:-${PRO_CHAT_PER_DAY:-300}}"
export NEXT_PUBLIC_WEB_SEARCH_FREE_PER_DAY="${NEXT_PUBLIC_WEB_SEARCH_FREE_PER_DAY:-${WEB_SEARCH_FREE_PER_DAY:-3}}"
export NEXT_PUBLIC_WEB_SEARCH_PRO_PER_DAY="${NEXT_PUBLIC_WEB_SEARCH_PRO_PER_DAY:-${WEB_SEARCH_PRO_PER_DAY:-30}}"
export NEXT_PUBLIC_PRO_PREMIUM_PER_DAY="${NEXT_PUBLIC_PRO_PREMIUM_PER_DAY:-${PRO_PREMIUM_PER_DAY:-30}}"
